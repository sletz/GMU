...
void   rand_dist_list_dsp64(t_rand_dist_list* x, t_object* dsp64, short* count, double samplerate,
                            long maxvectorsize, long flags);
double rand_dist_list_gen(t_rand_dist_list* x);
void   rand_dist_list_perform64(t_rand_dist_list* x, t_object* dsp64, double** ins, long numins,
...
{
    t_class* c =
        class_new("rand_dist_list~", (method)rand_dist_list_new, (method)rand_dist_list_free,
                  sizeof(t_rand_dist_list), (method)NULL, A_GIMME, 0);
