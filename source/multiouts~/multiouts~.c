...
{
    t_class* c;
    c = class_new("multiouts~", (method)multiouts_new, (method)dsp_free, sizeof(t_multiouts), NULL,
                  A_DEFFLOAT, A_DEFFLOAT, 0);

    // class_addmethod(c, (method)multiouts_dsp, "dsp", A_CANT, 0); 	// respond to the dsp
    // message
    ...
    if (m == 2) {
        ...
        switch (a) {
            case 0:
                ...
                break;
            case 1:
                sprintf(s, "(float) Direction (0-1) (percent of 360 clockwise) default 0 => out1");
                break;
            case 2:
                sprintf(s, "(float) Distance (0-1) default 1");
                break;
            case 3:
                sprintf(s, "(int) Line Time (ms)");
                break;
        }
    }
}
...
void multiouts_ft1(t_multiouts* x, double teta)
{
    ...
    switch (x->x_nouts) {
        case 2:
            multiouts_floatval2(x);
            break;
        case 3:
            multiouts_floatval3(x);
            break;
        case 4:
            multiouts_floatval4(x);
            break;
        case 5:
            multiouts_floatval5(x);
            break;
        case 6:
            multiouts_floatval6(x);
            break;
        case 7:
            multiouts_floatval7(x);
            break;
        case 8:
            multiouts_floatval8(x);
            break;
        case 9:
            multiouts_floatval9(x);
            break;
        case 10:
            multiouts_floatval10(x);
            break;
        case 11:
            multiouts_floatval11(x);
            break;
        case 12:
            multiouts_floatval12(x);
            break;
        case 13:
            multiouts_floatval13(x);
            break;
        case 14:
            multiouts_floatval14(x);
            break;
        case 15:
            multiouts_floatval15(x);
            break;
        case 16:
            multiouts_floatval16(x);
    }
...
void multiouts_perform2(t_multiouts* x, t_object* dsp64, double** ins, long numins, double** outs,
...
void* multiouts_perform3(t_multiouts* x, t_object* dsp64, double** ins, long numins, double** outs,
                         long numouts, long sampleframes, long flags, void* userparam)
{
...
void* multiouts_perform4(t_multiouts* x, t_object* dsp64, double** ins, long numins, double** outs,
                         long numouts, long sampleframes, long flags, void* userparam)
{
...
void* multiouts_perform5(t_multiouts* x, t_object* dsp64, double** ins, long numins, double** outs,
                         long numouts, long sampleframes, long flags, void* userparam)
{
...
void* multiouts_perform6(t_multiouts* x, t_object* dsp64, double** ins, long numins, double** outs,
                         long numouts, long sampleframes, long flags, void* userparam)
{
...
void* multiouts_perform7(t_multiouts* x, t_object* dsp64, double** ins, long numins, double** outs,
                         long numouts, long sampleframes, long flags, void* userparam)
{
...
void* multiouts_perform8(t_multiouts* x, t_object* dsp64, double** ins, long numins, double** outs,
                         long numouts, long sampleframes, long flags, void* userparam)
{
...
void* multiouts_perform9(t_multiouts* x, t_object* dsp64, double** ins, long numins, double** outs,
                         long numouts, long sampleframes, long flags, void* userparam)
{
    float  val1, val2, val3, val4, val5, val6, val7, val8;
    float  val9;
...
void* multiouts_perform10(t_multiouts* x, t_object* dsp64, double** ins, long numins, double** outs,
                          long numouts, long sampleframes, long flags, void* userparam)
{
    float  val1, val2, val3, val4, val5, val6, val7, val8;
    float  val9, val10;
...
void* multiouts_perform11(t_multiouts* x, t_object* dsp64, double** ins, long numins, double** outs,
                          long numouts, long sampleframes, long flags, void* userparam)
{
    float  val1, val2, val3, val4, val5, val6, val7, val8;
...
void* multiouts_perform12(t_multiouts* x, t_object* dsp64, double** ins, long numins, double** outs,
                          long numouts, long sampleframes, long flags, void* userparam)
{
    float  val1, val2, val3, val4, val5, val6, val7, val8;
...
void* multiouts_perform13(t_multiouts* x, t_object* dsp64, double** ins, long numins, double** outs,
                          long numouts, long sampleframes, long flags, void* userparam)
{
    float  val1, val2, val3, val4, val5, val6, val7, val8;
...
void* multiouts_perform14(t_multiouts* x, t_object* dsp64, double** ins, long numins, double** outs,
                          long numouts, long sampleframes, long flags, void* userparam)
{
    float  val1, val2, val3, val4, val5, val6, val7, val8;
...
void* multiouts_perform15(t_multiouts* x, t_object* dsp64, double** ins, long numins, double** outs,
                          long numouts, long sampleframes, long flags, void* userparam)
{
    float  val1, val2, val3, val4, val5, val6, val7, val8;
...
void* multiouts_perform16(t_multiouts* x, t_object* dsp64, double** ins, long numins, double** outs,
                          long numouts, long sampleframes, long flags, void* userparam)
{
    float  val1, val2, val3, val4, val5, val6, val7, val8;
                     ...
                     long maxvectorsize, long flags)
{
    ...
    switch (n) {
        case 2:
            object_method(dsp64, gensym("dsp_add64"), x, multiouts_perform2, 0, NULL);
            break;
        case 3:
            object_method(dsp64, gensym("dsp_add64"), x, multiouts_perform3, 0, NULL);
            break;
        case 4:
            object_method(dsp64, gensym("dsp_add64"), x, multiouts_perform4, 0, NULL);
            break;
        case 5:
            object_method(dsp64, gensym("dsp_add64"), x, multiouts_perform5, 0, NULL);
            break;
        case 6:
            object_method(dsp64, gensym("dsp_add64"), x, multiouts_perform6, 0, NULL);
            break;
        case 7:
            object_method(dsp64, gensym("dsp_add64"), x, multiouts_perform7, 0, NULL);
            break;
        case 8:
            object_method(dsp64, gensym("dsp_add64"), x, multiouts_perform8, 0, NULL);
            break;
        case 9:
            object_method(dsp64, gensym("dsp_add64"), x, multiouts_perform9, 0, NULL);
            break;
        case 10:
            object_method(dsp64, gensym("dsp_add64"), x, multiouts_perform10, 0, NULL);
            break;
        case 11:
            object_method(dsp64, gensym("dsp_add64"), x, multiouts_perform11, 0, NULL);
            break;
        case 12:
            object_method(dsp64, gensym("dsp_add64"), x, multiouts_perform12, 0, NULL);
            break;
        case 13:
            object_method(dsp64, gensym("dsp_add64"), x, multiouts_perform13, 0, NULL);
            break;
        case 14:
            object_method(dsp64, gensym("dsp_add64"), x, multiouts_perform14, 0, NULL);
            break;
        case 15:
            object_method(dsp64, gensym("dsp_add64"), x, multiouts_perform15, 0, NULL);
            break;
        case 16:
            object_method(dsp64, gensym("dsp_add64"), x, multiouts_perform16, 0, NULL);
            break;
    }
}
