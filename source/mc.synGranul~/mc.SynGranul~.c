...
// void synGranul_setInit(t_synGranul *x, t_symbol *s);	// definition du buffer~ son (�
...
{
    t_class* c = class_new("mc.synGranul~", (method)synGranul_new, (method)synGranul_free,
    ...
    class_addmethod(c, (method)synGranul_multichanneloutputs, "multichanneloutputs", A_CANT,
                    0);  // mc mulitchannel output
